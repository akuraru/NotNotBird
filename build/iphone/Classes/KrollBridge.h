...
@interface NotNotBirdObject : KrollCoverageObject {
#else
@interface NotNotBirdObject : KrollObject {
#endif
@private
...
extern NSString * NotNotBird$ModuleRequireFormat;

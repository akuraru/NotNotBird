 ...
 * Copyright (c) 2009-2011 by NotNotBird, Inc. All Rights Reserved.
...
//@interface NotNotBirdObject : NSObject
//@end

@interface NotNotBirdObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NotNotBirdObject class]])
		{
			for (NSString *key in [[(NotNotBirdObject*)o modules] allKeys])
			{

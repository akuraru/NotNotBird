...
// in simulator we redefine to format for NotNotBird Developer console
...
{\
	NSString * exceptionName = [@"org.notnotbird." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.notnotbird";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UINotNotBirdNativeItemNone = -1, 
	UINotNotBirdNativeItemSpinner = -2,
	UINotNotBirdNativeItemProgressBar = -3,
	
	UINotNotBirdNativeItemSlider = -4,
	UINotNotBirdNativeItemSwitch = -5,
	UINotNotBirdNativeItemMultiButton = -6,
	UINotNotBirdNativeItemSegmented = -7,
	
	UINotNotBirdNativeItemTextView = -8,
	UINotNotBirdNativeItemTextField = -9,
	UINotNotBirdNativeItemSearchBar = -10,
	
	UINotNotBirdNativeItemPicker = -11,
	UINotNotBirdNativeItemDatePicker = -12,
	
	UINotNotBirdNativeItemInfoLight = -13,
	UINotNotBirdNativeItemInfoDark = -14,
	
	UINotNotBirdNativeItemDisclosure = -15,
	
	UINotNotBirdNativeItemContactAdd = -16
};
